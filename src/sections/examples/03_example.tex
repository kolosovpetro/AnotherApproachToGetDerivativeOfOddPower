\begin{example}
    ...
    Consider the explicit form of the function $f_{3} (x, z)$, that is
    \begin{align*}
    ...
    \end{align*}
    Therefore, the partial derivative of $(f_3) ^{'}_{x}$ with respect to $x$ equals to
    \begin{align*}
    (f_3) ^{'}_{x} &= -7 z + 28 x z - 42 z^2 + 105 x^2 z^2 - 280 x z^3 + 210 x^2 z^3 + 175 z^4 - 420 x z^4 \\
        &+ 105 x^2 z^4 + 210 z^5 - 168 x z^5 + 70 z^6
    \end{align*}
    Consider the partial derivative $(f_3) ^{'}_{z}$ with respect to $z$, that is
    \begin{align*}
